...
/**
 * @title Lizard Academy Certificate of Competency NFT
 * @notice Soul-bound NFT certificates - non-transferable proof of competency
 * @dev ERC721 with transfer restrictions for educational credentials
 */
contract LizardAcademyCompetencyCertificateNFT is ERC721, Ownable, Pausable {
    ...
    constructor() ERC721("Lizard Academy Certificate of Competency", "LACC") {}
    ...
    function _exists(uint256 tokenId) internal view returns (bool) {
        return certificates[tokenId].student != address(0);
    }
}