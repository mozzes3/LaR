  ...
  return (
    <>
      ...
      {showSearchModal && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-900 rounded-2xl max-w-2xl w-full border-2 border-gray-200 dark:border-gray-800 p-6"
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" && e.target.value.trim()) {
                    navigate(
                      `/courses?search=${encodeURIComponent(e.target.value)}`
                    );
